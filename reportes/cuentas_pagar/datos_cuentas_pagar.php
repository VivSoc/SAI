...
$sql = "SELECT * FROM clientes_proveedores  where id_cli_pro = '".@$_REQUEST['id_proveedor_cxp']."' and estatus='A'";
...
$sql = "SELECT a.*,b.num_documento,c.des_tip_documento FROM cuentas_pagar a,compras b,tipos_documentos c where a.id_cli_pro = '".@$_REQUEST['id_proveedor_cxp']."' and b.id_compra=a.id_compra and c.id_tip_documento=b.id_tipo_doc_com order by a.id_compra";
$result = pg_query($bd_conexion,$sql);
?>
<table  width="100%" align="center" class='tbldatos1'>    
	<tr>
	...
	<tr>
		...
		<td align="center" class="fondo_fila_amarilla">Monto de la Compra</td>
		<td align="center" class="fondo_fila_amarilla">Monto Abonado</td>
		<td align="center" class="fondo_fila_amarilla">Saldo Pendiente</td>
        
	</tr>
<?php
$total_cta=$total_abonado=$total_saldo=0;
while(($datos=pg_fetch_assoc($result))>0)
{
	...
	echo 
	"<tr>
	<td align='right'><a href='javascript:buscar_abonos_cxp(&#39;".$idcxp."&#39;,&#39;".$idcompra."&#39;,".$saldo.",".$abonado.")' style='text-decoration:underline; color:#06F;'>".$datos['id_compra']."</a></td>
...
echo "
	...
	<td align='center'></td>
	<td align='center'></td>
	<td align='right'>".number_format($total_cta,2)."</td>
	<td align='right'>".number_format($total_abonado,2)."</td>
	<td align='right'>".number_format($total_saldo,2)."</td>
	</tr>";
?> 
<td colspan="9"></td>
</table>
<div id="datos_abonos_cxp" ></div>
<table  width="100%" align="center" class='tbldatos1' >
<tr>
	<td colspan="9" width="50%" align="center">
	<button type="button" id="imprimir_cuentas_cxp" name="imprimir_cuentas_cxp" title="Imprimir Reporte" onClick="imprimir_ctas_pagar();" style="width:65px; height:55px;"><img src="css/imagenes/iconos/imprimir.png"></button>
	</td>
</tr>
</table>    
</div>
