...
echo "<input type='hidden' name='mod_cat_seg2' id='mod_cat_seg2' value='$vector'>";
echo "<tr class='fondo_fila_amarilla'><td colspan='5' align='left'>Seleccionar Todos<input type='radio' name='mod_cat_seg3' onclick='asignar_permisos(\"".'mod_cat_seg2'."\",1)'>Seleccionar Ninguno<input type='radio' name='mod_cat_seg3' onclick='asignar_permisos(\"".'mod_cat_seg2'."\",0)'></td></tr>";
echo "</table>";
