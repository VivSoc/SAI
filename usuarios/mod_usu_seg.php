...
$sql="select p2.codapl,p2.nombre_modulo,p2.nombre_pestana from paraccsynnom p2 where  p2.estatus='A' and id_modulo='12' order by p2.nombre_modulo ";
$ok=pg_query($sql);
...
echo "<input type='hidden' name='mod_usu_seg2' id='mod_usu_seg2' value='$vector'>";
echo "<tr class='fondo_fila_amarilla'><td colspan='5' align='left'>Seleccionar Todos<input type='radio' name='mod_usu_seg3' onclick='asignar_permisos(\"".'mod_usu_seg2'."\",1)'>Seleccionar Ninguno<input type='radio' name='mod_usu_seg3' onclick='asignar_permisos(\"".'mod_usu_seg2'."\",0)'></td></tr>";
echo "</table>";
