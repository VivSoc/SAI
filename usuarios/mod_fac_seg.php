...
echo "<input type='hidden' name='mod_fac_seg2' id='mod_fac_seg2' value='$vector'>";
echo "<tr class='fondo_fila_amarilla'><td colspan='5' align='left'>Seleccionar Todos<input type='radio' name='mod_fac_seg3' onclick='asignar_permisos(\"".'mod_fac_seg2'."\",1)'>Seleccionar Ninguno<input type='radio' name='mod_fac_seg3' onclick='asignar_permisos(\"".'mod_fac_seg2'."\",0)'></td></tr>";
echo "</table>";
